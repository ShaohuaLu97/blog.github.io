...
function loadQuestion() {
    ...
    if(quiz.question >= quiz.total) {
        ...
        const div2 = makeEle('div', pieChart, 'chart', output);
        const btn5 = makeEle('button', 'Check Result in Graph', 'btn', div2);
        btn5.addEventListener('click', drawChart);
    }else{
...
function drawChart() {
  ...
  var options = {'title':'Number of Correct Answer vs Incorrect Answer', 'width':550, 'height':400};
