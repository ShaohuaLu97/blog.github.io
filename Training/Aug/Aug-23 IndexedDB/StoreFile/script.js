(function () {
   ...
   * @param {Blob=} blob
   */
  function addPublication(biblioid, title, blob) {
    console.log("addPublication arguments:", arguments);
    var obj = { biblioid: biblioid, title: title };
  ...
  function addEventListeners() {
    ...
    $("#add-button").click(function (evt) {
      ...
      if (selected_file) {
        addPublication(biblioid, title, selected_file);
      } else if (file_url) {
        addPublicationFromUrl(biblioid, title, file_url);
      } else {
        addPublication(biblioid, title);
      }
    });
